...
const Checkout = () => {
    ...
    useEffect(() => {
        const timer = setTimeout(() => setShowPopup(true), 100000); // Show popup after 10 seconds
            ...
            <div className="checkout-container">
                <div className="checkout-left">
                    ...
                    <div className="info-item">
                        <span className="label">Tên:</span> Nguyễn Văn A
                    </div>
                    <div className="info-item">
                        <span className="label">Mã học viên:</span> HV12345
                    </div>
                    <div className="info-item">
                        <span className="label">Số điện thoại:</span> 0123456789
                    </div>
                    <div className="info-item">
